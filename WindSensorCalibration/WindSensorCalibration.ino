...
void loop() {
  if (millis() - lastMillis > 200){ // read every 200 ms - printing slows this down further
   ...
   WindSpeed_KPH = 1.609344 * pow(((RV_Wind_Volts - zeroWind_volts) /.2300) , 2.7265);   

    // Output to Serial Monitor
    Serial.print("  TMP volts ");
    Serial.print(TMP_Therm_ADunits * board_voltage / 1023.0);
    ...
    Serial.print("   WindSpeed KPH ");
    Serial.println((float)WindSpeed_KPH);
    lastMillis = millis();    
  } 
